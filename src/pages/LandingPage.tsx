...
const LandingPage = () => {
  ...
  return (
    <div className="relative min-h-screen gradient-hero overflow-hidden flex flex-col">
      {/* Section Tabs */}
      <div className="relative z-20 w-full border-b border-border/20 backdrop-blur-md bg-background/20">
      ...
      <div className="flex-1 flex items-center justify-center relative">
        ...
        <div className="relative z-10 text-center px-4 max-w-2xl w-full">
          ...
          >
            ...
            >
              {isMobile ? (
                <img src={auLogo} alt="AU Logo" className="w-28 h-28 rounded-2xl" />
              ) : (
