...
const Timetable = ({ section = "A2" }: { section?: string }) => {
    ...
    return (
      <div>
        ...
        <div className="glass-card rounded-2xl p-8 text-center">
          ...
          <p className="text-sm text-muted-foreground mt-2">Timetable will be added soon.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold text-foreground mb-6">Weekly Timetable — Section {section}</h1>
